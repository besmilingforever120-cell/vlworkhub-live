...
import { AdminArchivedTasks } from "../../../components/admin-archived-tasks";
...
export default async function AdminArchivedTasksPage() {
  ...
  return (
    <div>
      <HrPortalHeader
        ...
        description="Browse archived task completions by user from the HR administration area."
        breadcrumb="Admin"
      />
      <AdminArchivedTasks />
    </div>
